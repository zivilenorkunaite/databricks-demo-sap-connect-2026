...
# MAGIC %md
# MAGIC # Generate Corporate Finance PDFs
# MAGIC
# MAGIC Creates 5 PDF documents and uploads them to a UC Volume.
# MAGIC These are the corporate governance documents the Finance Intelligence Agent references.
...
CATALOG = "zivile_bdc"
SCHEMA = "documents"  # Separate schema for corporate documents (not a BDC data product)
VOLUME = "finance_documents"
...
class FinancePDF(FPDF):
    ...
    def add_title(self, title, subtitle=""):
        ...
        self.set_text_color(27, 49, 57)  # Databricks dark
        ...
        self.ln(6)
        # Accent line
        self.set_draw_color(255, 54, 33)  # Databricks red
    ...
    def add_section(self, title):
        ...
        self.set_text_color(0, 112, 242)  # SAP blue
...
def save_pdf(pdf, filename):
    ...
    dbutils.fs.cp(f"file:{local_path}", f"dbfs:{volume_path}/{filename}")
...
# MAGIC %md
# MAGIC ## PDF 1: Corporate Procurement Policy
...
save_pdf(pdf, "corporate_procurement_policy.pdf")

# COMMAND ----------

# MAGIC %md
# MAGIC ## PDF 2: Supplier Code of Conduct
...
save_pdf(pdf, "supplier_code_of_conduct.pdf")

# COMMAND ----------

# MAGIC %md
# MAGIC ## PDF 3: Q4 2025 Internal Audit Report
...
save_pdf(pdf, "q4_2025_internal_audit_report.pdf")

# COMMAND ----------

# MAGIC %md
# MAGIC ## PDF 4: Treasury & Cash Management Policy
...
save_pdf(pdf, "treasury_cash_management_policy.pdf")

# COMMAND ----------

# MAGIC %md
# MAGIC ## PDF 5: Financial Close Procedures
...
save_pdf(pdf, "financial_close_procedures.pdf")

# COMMAND ----------

# Verify all PDFs
files = dbutils.fs.ls(f"dbfs:{volume_path}")
print(f"\nUploaded {len(files)} documents to {volume_path}:")
for f in files:
